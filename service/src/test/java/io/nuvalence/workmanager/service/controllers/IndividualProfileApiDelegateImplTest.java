...
class IndividualProfileApiDelegateImplTest {
    ...
    void postIndividualProfileInvitation_SuccessAndForbidden(
        ...
        when(profileInvitationService.saveProfileInvitation(
                        eq(ProfileType.INDIVIDUAL), any(), any(ProfileInvitation.class)))
                .thenReturn(savedInvitation);
        when(userManagementService.getUser(any()))
                .thenReturn(User.builder().id(UUID.randomUUID()).displayName("test").build());
    ...
    @Test
    void postIndividualProfileInvitation_forbidden() throws Exception {
    ...
    @Test
    void deleteIndividualProfileInvitation_forbidden() throws Exception {
